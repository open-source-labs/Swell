...
// v1.0 TypeScript - For reference only
// /* eslint-disable default-case */
// /* eslint-disable jsx-a11y/click-events-have-key-events */
// /* eslint-disable jsx-a11y/no-static-element-interactions */
// import React from 'react';
...
//   fieldsReplaced: ({}) => void,
//   newRequestHeadersSet: ({headersArr, count}: any) => void,
//   newRequestCookiesSet: ({cookiesArr, count}: any) => void,
//   newRequestBodySet: ({
//     bodyType,
//     bodyContent,
//     bodyVariables,
...
//   // method: Methods, network: Network, protocol: Protocol, isSSE: boolean, url: string, restUrl: string, graphQL: boolean, gRPC: boolean, webrtc: boolean
...
//   const deleteHistory = (event: any) => {
//     dispatch(historyDeleted({...content['request']}));
//     historyController.deleteHistoryFromIndexedDb(event.target.id);
//   };
...
//         />
//       </div>
//       <button>HISTORYHISTORYHISTORY</button>
//     </div>
//   );
// };
