...
const Header = ({ type, content, changeHandler, Key, value }) => (
  <div
    style={styles}
    className={`composer_header ${
      type === 'header' ? 'header_container' : 'cookie_container'
    }`}
  >
    ************** Header **************
    <input
      className={`composer_header_checkbox ${
        type === 'header' ? 'header_checkbox' : 'cookie_checkbox'
      }`}
      type="checkbox"
    ...
    <input
      className={`composer_header_input composer_header_input_first ${
        type === 'header' ? 'header_key' : 'cookie_key'
      }`}
      type="text"
      placeholder="Key"
      value={Key}
    ...
    <input
      className={`composer_header_input ${
        type === 'header' ? 'header_value' : 'cookie_value'
      }`}
      type="text"
      placeholder="Value"
      value={value}
