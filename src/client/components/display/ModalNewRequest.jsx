    ...
    return (
      <div style={{ border: '1px solid black', display: 'flex', flexDirection: 'column' }}>
        ...
        <HeaderEntryForm
          ...
          contentTypeHeader={this.state.contentTypeHeader}
        />
        <BodyEntryForm
          method={this.state.method}
          updateBody={this.updateBody}
          updateContentTypeHeader={this.updateContentTypeHeader}
        />
        <button onClick={this.addNewRequest} type="button">Add New Request</button>
      </div>
    );
  }
}
