...
class GRPCProtoEntryForm extends Component {
  ...
  submitUpdatedProto() {
    ...
    // then call this.props.setNewRequestSTreams etc.. with the data
    ...
    api.send(
      ...
      this.props.newRequestStreams.protoContent
    );
    /*
    ...
    return (
      <div>
        ...
        <button
          ...
          onClick={this.submitUpdatedProto}
        >
          Save Changes
        </button>
